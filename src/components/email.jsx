import {
  ...
  export default function ReactReceiptEmail(receiverName, receiverNumber, receiverAddress){
    return(
    <Html>
      <Head />
        ...
        <Container style={container}>
          ...
          <Section style={message}>
            <Img
              ...
              style={{ margin: 'auto' }}
            />
            <Heading style={global.heading}>Thanks {receiverName} for trying the demo, I really appreciate that !</Heading>
            ...
            <Text style={global.text}>
              We will contact you using: {receiverNumber}
            </Text>
